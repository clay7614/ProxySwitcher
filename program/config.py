...
# 環境変数関連
ENVIRONMENT_KEY_PATH = r"Environment"
PATH_VALUE_NAME = "Path"
HWND_BROADCAST = 0xFFFF
WM_SETTINGCHANGE = 0x001A
SMTO_ABORTIFHUNG = 0x0002

# アイコンデータ (a.py で生成されたもの)
# この文字列は非常に長いため、実際のアプリケーションでは a.py を実行して
# 生成されたものをここにコピー＆ペーストしてください。
# ここでは proxy.py から移動したことを示すために一部のみ記載します。
